// Set target date (DE) UTC (-1 hour) (year, month (0-11), day, hour, minute, second, millisecond)
...
let interval = setInterval(() => {
	...
	if (distance < 0) {
		...
		// Display values
		document.getElementById("timer").innerHTML = formatNum(days) + " : " + formatNum(hours) + " : " + formatNum(minutes) + " : " + formatNum(seconds);
	}
}, 1 * FACTOR_SEC);